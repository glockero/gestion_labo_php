...
<div class="admin-shell">
    <div class="admin-page-header">
        <div>
            <h2 class="admin-page-title"><i class="bi bi-clock-history text-primary me-1"></i> Historial General</h2>
            <p class="admin-page-subtitle">Auditoria de acciones, usuarios, importaciones y cambios sobre reparaciones.</p>
        </div>
    </div>
<div class="admin-filter-bar">
        <form method="GET" action="historial.php" class="row g-2 align-items-center">
            <div class="col-md-10">
                <input type="text" name="q" class="form-control" placeholder="Buscar por acción, usuario, NPU o detalle..." value="<?= e($busqueda) ?>">
            </div>
            <div class="col-md-2">
                <button type="submit" class="btn btn-primary w-100 admin-btn-sm"><i class="bi bi-search"></i> Buscar</button>
            </div>
        </form>
</div>

<div class="admin-card">
    <div class="historial-table-scroll admin-table-scroll">
    ...
    <div class="border-top bg-white d-flex justify-content-center p-2">
        <nav>
